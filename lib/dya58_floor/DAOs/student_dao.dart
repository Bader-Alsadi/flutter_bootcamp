...
abstract class StudentDao {
  ...
  @Query(
      "select * from StidentX join Department on StidentX.depratmentId=Department.id where StidentX.id= :id")
  Future<Student?> getOneStrudent(int id);
  @Query(
      "select * from StidentX where id in (select StudentId from RegCourse where CourseId= :CourseId)")
