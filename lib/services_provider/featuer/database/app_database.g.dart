  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Inquiry` (`id` INTEGER, `Inquiry_name` TEXT NOT NULL, `replay` TEXT, `user_id` INTEGER NOT NULL, `Service_provider_id` INTEGER NOT NULL, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Location` (`id` INTEGER, `descripction` TEXT NOT NULL, `user_id` INTEGER NOT NULL, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Order` (`id` INTEGER, `User_id` INTEGER NOT NULL, `Service_id` INTEGER NOT NULL, `state` TEXT, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Rating` (`id` INTEGER, `rate` INTEGER NOT NULL, `user_id` INTEGER NOT NULL, `order_id` INTEGER NOT NULL, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Service` (`id` INTEGER, `Service_name` TEXT NOT NULL, `description` TEXT NOT NULL, `category_id` INTEGER NOT NULL, `Service_provider_id` INTEGER NOT NULL, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ServiceProvider` (`id` INTEGER, `career` TEXT NOT NULL, `detilas` TEXT, `create_at` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `User` (`id` INTEGER, `user_name` TEXT NOT NULL, `cell_phone` TEXT NOT NULL, `user_image` TEXT, `area_id` INTEGER NOT NULL, `create_at` TEXT, PRIMARY KEY (`id`))');
